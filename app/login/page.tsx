...
const s: Record<string, React.CSSProperties> = {
  ...
  card: {
    background: '#141414', border: '1px solid #222222', borderRadius: '16px',
  ...
  input: {
    padding: '0.75rem 1rem', background: '#0d0d0d', border: '1px solid #2a2a2a',
    borderRadius: '8px', fontSize: '0.9375rem', color: '#ffffff', outline: 'none', fontFamily: 'inherit',
  },
  errorMsg: {
    fontSize: '0.8125rem', color: '#f87171',
    background: 'rgba(248, 113, 113, 0.08)', border: '1px solid rgba(248, 113, 113, 0.2)',
    borderRadius: '6px', padding: '0.625rem 0.875rem', lineHeight: 1.5,
  },
  submitBtn: {
    marginTop: '0.25rem', padding: '0.875rem', background: '#ff6b35',
    color: '#000000', border: 'none', borderRadius: '8px', fontSize: '0.9375rem',
