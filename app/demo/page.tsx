...
export default function TestForm() {
  ...
  return (
    <>
      <div className="demo-page-wrap" style={{ minHeight: '100vh', background: '#0a0a0a', fontFamily: "'Inter', -apple-system, sans-serif", overflowX: 'hidden' }}>
        <BlogNav />
      <ScrollReveal />
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                  ...
                  <div>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '0.625rem' }}>
                      {[
                        { value: 'pro', label: 'Pro', price: '$394/mo', desc: 'HIPAA + AI voice + multi-location' },
