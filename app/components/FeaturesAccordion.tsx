...
const features = [
  ...
  },
  {
    ...
    text: "These leads don\u2019t exist in your CRM. They don\u2019t show up in Google Analytics. They never hit submit. But they were there \u2014 typing, interested, ready to book. We make them visible.",
    icon: '<path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z" /><circle cx="12" cy="12" r="3" />'
  },
  {
    title: 'Revenue-at-Risk Calculator',
    text: "Every abandoned lead shows its dollar value based on your average service price. Watch in real time as the revenue you\u2019re losing adds up \u2014 then recover it.",
    icon: '<line x1="12" y1="1" x2="12" y2="23" /><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6" />'
  },
  {
    title: 'Universal Tracking',
    text: 'One script tag works on any website \u2014 WordPress, Wix, Webflow, Squarespace, custom HTML. Install in 60 seconds. Zero configuration.',
  ...
  {
    title: 'Lead Pipeline',
    text: "Track every lead from capture to close \u2014 Open, Contacted, Converted, or Lost. Know your exact recovery rate and see which follow-ups are working.",
    icon: '<polyline points="22 12 18 12 15 21 9 3 6 12 2 12" />'
  },
  {
    title: 'Analytics Dashboard',
    text: 'Real-time metrics, revenue tracking, and complete visibility into every lead. Updated the moment someone touches your form. No guessing.',
