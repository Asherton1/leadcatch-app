    ...
    <>
      <div className="nav-desktop">
        ...
        <div className="nav-dropdown-wrapper">
          <span className={(isActive('/pricing') || isActive('/enterprise')) ? 'nav-link nav-active' : 'nav-link'} style={{ cursor: 'pointer', display: 'inline-flex', alignItems: 'center', gap: '4px' }}>Pricing <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="6 9 12 15 18 9"/></svg></span>
          <div className="nav-dropdown-menu">
            <Link href="/pricing" className="nav-dropdown-item">Plans &amp; pricing</Link>
            <Link href="/enterprise" className="nav-dropdown-item">Multi-location</Link>
          </div>
        </div>
        ...
        <div style={{ padding: '1rem 0' }} onClick={() => setOpen(false)}>
          ...
          <div style={{ borderTop: '1px solid #1e1e1e', marginTop: '0.25rem' }}>
            ...
            <div style={{
              ...
              <Link href="/contact" className={isActive('/contact') ? 'mobile-link-active' : ''} style={{ paddingLeft: '2.5rem' }}>Contact</Link>
            </div>
          </div>
