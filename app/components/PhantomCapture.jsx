...
/**
 * PhantomCapture — v19: Dallas dusk video + signal capture network overlay
 * --------------------------------------------------------------------------
 * Earth video swapped for Dallas dusk drone footage (Pexels 15613466 by Jim Baker).
 * Margaret Hunt Hill Bridge + downtown skyline at golden hour.
 * Same overlay pattern, parameters tuned for dusk lighting.
 *
 * Layer stack (bottom to top):
 *   1. .hero #0a0604 dark base
 *   2. Dallas dusk video (dimmed)
