    ...
    <div className={'fc' + (open ? ' fc-open' : '')}>
      ...
      <div className="fc-drawer" style={{ gridTemplateRows: open ? '1fr' : '0fr' }}>
        <div className="fc-drawer-inner">
          <div className="fc-bio" style={{ fontSize: '14px', lineHeight: '1.7' }}>
            ...
            <p>I still run paid media for a small number of clients alongside building ReCapture, and that work is where most of the product came from. If it is relevant to you, <a href="/paid-media" className="fc-link">how I approach it is here</a>.</p>
