  ...
  return (
    <section className="lc-section reveal">
      ...
      <div className="td-summary">
        <p>
          ReCapture starts at <strong>$394/mo</strong>. Transparent pricing, no add-ons, HIPAA included on Pro with no lock-in, one-day install. Built specifically for high-ticket service businesses — the buyers these tools weren&apos;t designed for.
        </p>
      </div>
