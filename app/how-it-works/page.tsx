...
const FAQS: { question: string; answer: string }[] = [
  ...
  { question: "How does ReCapture know which leads abandoned vs submitted?", answer: "ReCapture reads a contact field\u2019s value once the visitor has finished entering it \u2014 never individual keystrokes, and never a session recording. If they complete identifying fields (name, email, phone) but leave without submitting, whether by closing the tab, navigating away, or leaving the form sitting incomplete, that counts as abandonment and triggers your recovery sequence." },
