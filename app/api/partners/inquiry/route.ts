...
<tr><td style="padding:8px 0;color:#888;width:140px;">Name</td><td style="padding:8px 0;color:#fff;">${escapeHtml(name)}</td></tr>
<tr><td style="padding:8px 0;color:#888;">Agency</td><td style="padding:8px 0;color:#fff;">${escapeHtml(agency)}</td></tr>
${role ? `<tr><td style="padding:8px 0;color:#888;">Role</td><td style="padding:8px 0;color:#fff;">${escapeHtml(role)}</td></tr>` : ''}
...
${clientCount ? `<tr><td style="padding:8px 0;color:#888;">Client count</td><td style="padding:8px 0;color:#fff;">${escapeHtml(clientCount)}</td></tr>` : ''}
${verticals ? `<tr><td style="padding:8px 0;color:#888;">Verticals</td><td style="padding:8px 0;color:#fff;">${escapeHtml(verticals)}</td></tr>` : ''}
