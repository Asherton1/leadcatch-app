      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center' }}>
          <svg width="60" height="60" viewBox="0 0 24 24" fill="none"
               xmlns="http://www.w3.org/2000/svg" style={{ marginRight: '12px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'baseline' }}>
            <span style={{ color: '#ffffff', fontSize: 64, fontWeight: 700, letterSpacing: '-0.03em', fontFamily: 'Inter' }}>Re</span>
            <span style={{ color: '#ff6b35', fontSize: 64, fontWeight: 700, letterSpacing: '-0.03em', fontFamily: 'Inter' }}>Capture</span>
          </div>
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ fontSize: 78, fontWeight: 800, lineHeight: 1.08, letterSpacing: '-0.03em',
                        display: 'flex', flexWrap: 'wrap', color: '#ffffff', fontFamily: 'Inter' }}>
            {parts.map((part, i) => (
              <span key={i} style={{ color: i % 2 === 1 ? '#ff6b35' : '#ffffff',
        ...
        <div style={{ display: 'flex', alignItems: 'center' }}>
          <div style={{ width: '72px', height: '4px', background: '#ff6b35',
                        display: 'flex', marginRight: '18px' }} />
          <div style={{ color: '#888888', fontSize: 22, fontWeight: 600,
                        letterSpacing: '0.04em', display: 'flex', fontFamily: 'Inter' }}>
            userecapture.com
          </div>
        </div>
      </div>
