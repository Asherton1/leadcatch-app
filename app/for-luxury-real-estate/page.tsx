    ...
    <div style={{ minHeight: '100vh', background: '#0a0a0a', fontFamily: "'Inter', -apple-system, sans-serif" }}>
      ...
      <div style={{ maxWidth: '100%', background: 'linear-gradient(rgba(10, 10, 10, 0.75), rgba(10, 10, 10, 0.85)), url("/hero-bg.jpg") center/cover no-repeat', padding: '8rem 2rem 4rem' }}>
        <div style={{ maxWidth: '720px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <h1 style={{ fontSize: 'clamp(1.75rem, 5vw, 2.75rem)', fontWeight: 800, letterSpacing: '-0.03em', lineHeight: 1.15, marginBottom: '1.5rem', color: '#fff' }}>Your Highest-Value Buyers Are Inquiring — Then Disappearing</h1>
      ...
      <div className="blog-post-body" style={{ maxWidth: '720px', margin: '0 auto', padding: '1rem 2rem 3rem' }}>
        ...
        <h2 className="reveal">The Hidden Cost of Luxury Real Estate Forms</h2>
        ...
        <h2 className="reveal">Why Luxury Real Estate Loses More Than Most</h2>
        ...
        <h2 className="reveal">How ReCapture Works for Real Estate</h2>
        ...
        <h2 className="reveal">Built for Multi-Agent Brokerages</h2>
        ...
        <h2 className="reveal">See How Much Your Brokerage Is Losing</h2>
