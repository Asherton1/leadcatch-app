...
const FAQS: { question: string; answer: string }[] = [
  { question: "How does ReCapture work for luxury real estate inquiry forms?", answer: "Buyer inquiry forms — property tour requests, showing schedules, listing alerts — typically see the 60-70% abandonment Baymard Institute documented in 2024. ReCapture captures the name, email, phone, and property of interest from anyone who starts typing, and triggers immediate recovery within 60 seconds via email, SMS, or AI voice callback." },
  ...
  { question: "Does ReCapture integrate with Follow Up Boss, Compass, or kvCORE?", answer: "Yes. Follow Up Boss, Compass and kvCORE all connect by webhook, which pushes each captured lead into your pipeline in real time with the property metadata included. Setup usually takes under ten minutes." },
]
    ...
    <div style={{ minHeight: '100vh', background: '#0a0a0a', fontFamily: "'Inter', -apple-system, sans-serif", color: '#e4e4e7' }}>
      ...
      <div style={{ maxWidth: '720px', margin: '0 auto', padding: '2rem' }}>
        ...
        <section className="reveal" style={{ marginTop: '2rem', marginBottom: '3rem' }}>
          ...
          <div style={{ color: '#a1a1aa', lineHeight: 1.8, fontSize: '1rem' }}>
            <p>
              <strong style={{ color: '#e4e4e7' }}>Pro</strong> at $397/mo for solo agents and small teams. Includes recovery dashboard, tracker, automated follow-up emails, AI voice callback within 60 seconds, and instant SMS/Slack alerts.
            </p>
            <p>
