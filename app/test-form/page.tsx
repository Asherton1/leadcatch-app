...
export default function TestForm() {
  ...
  function handleSubmit(e: React.FormEvent) {
    e.preventDefault()
    // track.js listens for the submit event on the form and sends a final ping
    setSubmitted(true)
  }
  ...
  return (
    <>
      {/* Universal LeadCatch tracking script — same one-liner clients paste on any site */}
      <Script
      ...
      <div style={s.page}>
        <div style={s.card}>
          ...
          {/* Progress bar — driven by React state for visual feedback */}
...
const s: Record<string, React.CSSProperties> = {
  ...
  title: { fontSize: '1.5rem', fontWeight: 700, color: '#ffffff', marginBottom: '0.25rem', letterSpacing: '-0.02em' },
  subtitle: { fontSize: '0.875rem', color: '#737373' },
