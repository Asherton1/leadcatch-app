...
function IconBolt() {
  return <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff6b35" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2" /></svg>
}
function IconChart() {
  return <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff6b35" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="18" y1="20" x2="18" y2="10" /><line x1="12" y1="20" x2="12" y2="4" /><line x1="6" y1="20" x2="6" y2="14" /></svg>
}
function IconMail() {
  return <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff6b35" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="4" width="20" height="16" rx="2" /><polyline points="22,7 12,13 2,7" /></svg>
}
function IconPlug() {
  return <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff6b35" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22v-5" /><path d="M9 8V2" /><path d="M15 8V2" /><path d="M18 8v5a6 6 0 0 1-6 6v0a6 6 0 0 1-6-6V8Z" /></svg>
}
function IconShield() {
  return <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#ff6b35" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" /></svg>
}
...
export default function TestForm() {
  ...
  return (
    <>
      ...
      <div className="demo-page">
        ...
        <div className="demo-grid">
          <div className="demo-left">
            ...
            <h1 className="demo-h1">See ReCapture<br />in Action</h1>
            <p className="demo-desc">Fill out the form, then close this tab without submitting. Your partial data would appear in your ReCapture dashboard — that&apos;s real-time form capture.</p>
            ...
            {!submitted ? (
              <div className="demo-card">
                ...
                <form onSubmit={handleSubmit} className="demo-form">
                  <div><label className="demo-lbl">Full Name</label><input className="demo-inp" type="text" name="name" placeholder="Jane Smith" value={fields.name} onChange={e => handleChange('name', e.target.value)} /></div>
                  <div><label className="demo-lbl">Email Address</label><input className="demo-inp" type="email" name="email" placeholder="jane@example.com" value={fields.email} onChange={e => handleChange('email', e.target.value)} /></div>
                  <div><label className="demo-lbl">Phone Number</label><input className="demo-inp" type="tel" name="phone" placeholder="(214) 555-0100" value={fields.phone} onChange={e => handleChange('phone', e.target.value)} /></div>
                  <div>
                    <label className="demo-lbl">Business Type</label>
                    <select className="demo-inp demo-sel" name="service" value={fields.service} onChange={e => handleChange('service', e.target.value)}>
                  ...
                  <div><label className="demo-lbl">Message <span style={{ fontWeight: 400, color: '#444', textTransform: 'none' }}>(optional)</span></label><textarea className="demo-inp demo-ta" name="message" rows={3} placeholder="Tell us about your business…" value={fields.message} onChange={e => handleChange('message', e.target.value)} /></div>
              ...
              <div className="demo-card" style={{ textAlign: 'center' }}>
                <div className="demo-success-icon"><svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#10b981" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12" /></svg></div>
                ...
                <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
                  <Link href="/" className="demo-outline-btn">Back to Home</Link>
                  <button onClick={() => { setFields(EMPTY); setSubmitted(false) }} className="demo-outline-btn" style={{ fontFamily: 'inherit' }}>Submit Another</button>
                </div>
              </div>
            )}
          </div>
      ...
      <style jsx>{`
        .demo-page { min-height: 100vh; background: #0a0a0a; font-family: 'Inter', -apple-system, sans-serif; }
        .demo-grid { max-width: 1100px; margin: 0 auto; padding: 2rem 2rem 5rem; display: grid; grid-template-columns: 1fr 1fr; gap: 4rem; align-items: start; }
        .demo-left { padding-top: 1rem; }
        .demo-eyebrow { font-size: 0.875rem; font-weight: 600; color: #ff6b35; letter-spacing: 0.15em; text-transform: uppercase; margin-bottom: 1.5rem; }
        .demo-h1 { font-size: 2.5rem; font-weight: 800; color: #fff; letter-spacing: -0.03em; line-height: 1.15; margin-bottom: 1.25rem; }
        .demo-desc { font-size: 1rem; color: #888; line-height: 1.8; margin-bottom: 2.5rem; }
        .demo-features { display: flex; flex-direction: column; gap: 1.25rem; }
        ...
        .demo-callout { margin-top: 2rem; padding: 1.25rem 1.5rem; background: rgba(255,107,53,0.04); border: 1px solid rgba(255,107,53,0.12); border-radius: 10px; }
        ...
        .demo-sel { cursor: pointer; appearance: none; }
        .demo-ta { resize: vertical; line-height: 1.5; }
        ...
        .demo-success-icon { width: 56px; height: 56px; border-radius: 50%; background: rgba(16,185,129,0.1); border: 2px solid #10b981; display: flex; align-items: center; justify-content: center; margin: 0 auto 1.5rem; }
        .demo-outline-btn { padding: 0.75rem 1.5rem; background: transparent; border: 1px solid #1e1e1e; border-radius: 8px; color: #bbb; text-decoration: none; font-size: 0.875rem; cursor: pointer; transition: border-color 0.2s; }
        .demo-outline-btn:hover { border-color: #333; }
        @media (max-width: 768px) {
          .demo-grid { grid-template-columns: 1fr !important; gap: 2rem !important; padding: 1rem 1.25rem 3rem !important; }
          .demo-h1 { font-size: 1.75rem; }
          .demo-desc { font-size: 0.9rem; margin-bottom: 1.5rem; }
          .demo-card { padding: 1.75rem 1.25rem; }
          .demo-callout { margin-top: 1.5rem; padding: 1rem 1.25rem; }
