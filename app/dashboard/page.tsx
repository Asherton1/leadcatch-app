    ...
    <div className="dashboard">
      ...
      <header className="header">
        <div className="logo">
          ...
          {isAdmin && <a href="/dashboard/outreach" style={{ fontSize: '0.6rem', fontWeight: 700, letterSpacing: '0.12em', color: '#ff6b35', background: 'rgba(255,107,53,0.1)', border: '1px solid rgba(255,107,53,0.3)', borderRadius: '4px', padding: '2px 6px', textDecoration: 'none', marginLeft: '6px' }}>OUTREACH</a>}
        </div>
