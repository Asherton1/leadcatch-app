    ...
    <div className="about-page">
      ...
      <div className="about-founder reveal">
        ...
        <div className="about-founder-info">
          ...
          <h2>Asherton C.</h2>
          <p className="about-founder-bio">Bachelor&apos;s degree in Art & Design with a minor in Marketing and Business. Over a decade running digital campaigns for high-ticket businesses — med spas, dental practices, luxury real estate, property management — managing $100K+ in monthly ad spend across 38+ long-term client relationships. Not an agency. Not a freelancer. A partner who stays.</p>
          <p className="about-founder-bio">Equal parts creative and analytical. The kind of person who sees a 68% form abandonment rate and can&apos;t sleep until he understands why — then builds the system to fix it. Obsessed with the intersection of technology, behavioral psychology, and design that actually converts.</p>
          <p className="about-founder-bio">Dallas became home — not because it was planned, but because the city matched the energy. Most mornings start on the Katy Trail. Every other weekend he&apos;ll try a restaurant he hasn&apos;t been to yet or get lost in a conversation that goes longer than it should. The rest of the time, he&apos;s building. That same restless curiosity is what built ReCapture — a decade of watching leads slip through the cracks and finally deciding to do something about it.</p>
