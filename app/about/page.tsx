    ...
    <div className="about-page">
      ...
      <div className="about-hero">
        <div className="about-hero-content">
          <p style={{ fontSize: '1rem', fontWeight: 600, color: '#ff6b35', letterSpacing: '0.15em', textTransform: 'uppercase', marginBottom: '2rem' }}>Our Story</p>
      ...
      <div className="about-founder reveal">
        ...
        <div className="about-founder-info">
          ...
          <h2>Asherton C.</h2>
          <p className="about-founder-bio">Bachelor&apos;s degree in Art & Design with a minor in Marketing and Business. Over a decade in digital marketing and advertising — managing $100K+ in monthly ad spend across 38+ long-term clients spanning med spas, dental practices, luxury real estate, and high-end service businesses.</p>
          <p className="about-founder-bio">Equal parts creative and analytical — the kind of person who reverse-engineers why people do what they do online and builds systems around it. Fascinated by the intersection of technology, behavioral science, and design.</p>
          <p className="about-founder-bio">Originally from Casablanca, Morocco — grew up between cultures, languages, and perspectives that shaped how he sees everything from branding to human behavior. Moved to the U.S., earned his degree, and spent the next decade buried in ad accounts, funnels, and client calls. Dallas became home — not because it was planned, but because the city matched the energy. You&apos;ll find him on the Katy Trail most mornings, trying a restaurant he hasn&apos;t been to yet, or deep in a conversation that goes longer than it should. That same curiosity and obsession with understanding people is what led to ReCapture — built from a decade of watching the same problem and finally deciding to fix it.</p>
