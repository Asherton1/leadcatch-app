    ...
    <div className="about-page">
      ...
      <div className="about-founder">
        <div className="about-founder-image">
          <Image src="/founder.png" alt="Asherton C. \u2014 Founder of ReCapture" width={400} height={400} style={{ objectFit: 'cover', filter: 'grayscale(100%)', borderRadius: '12px', width: '100%', height: 'auto' }} />
        </div>
