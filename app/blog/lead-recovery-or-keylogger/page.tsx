  ...
  return (
    <div className="blog-post">
      ...
      <div style={{ position: 'relative', width: '100%', height: '400px', borderRadius: '12px', overflow: 'hidden', margin: '0 0 2rem 0' }}>
        <Image src="/blog-lead-recovery-keylogger.webp" alt="How to tell honest form-abandonment recovery from keystroke logging" fill style={{ objectFit: 'cover' }} />
      </div>
      ...
      <article className="blog-post-body">
          ...
          <p>
            All of it is laid out in plain language on our <Link href="/privacy" style={{ color: '#ff6b35' }}>Privacy &amp; Data</Link> page and in full detail on our <Link href="/trust" style={{ color: '#ff6b35' }}>Trust &amp; Compliance</Link> page. For the communication side of compliance &mdash; TCPA, CAN-SPAM, GDPR, and HIPAA as they govern follow-up &mdash; we wrote a companion piece on <Link href="/blog/the-form-abandonment-compliance-problem" style={{ color: '#ff6b35' }}>the form-abandonment compliance problem</Link>.
          </p>
          <p>
