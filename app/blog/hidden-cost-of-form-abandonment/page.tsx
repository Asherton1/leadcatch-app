...
export const metadata = {
  ...
  description: "Most businesses track traffic and ad spend but ignore the leads that start a form and never finish. Here's what that blind spot is really costing.",
}
  ...
  return (
    <div className="blog-post">
      ...
      <div className="blog-post-body">
        ...
        <h2>Why Traditional Analytics Miss This Entirely</h2>
