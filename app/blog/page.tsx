  ...
  return (
    <div className="blog-page">
      ...
      <div className="blog-featured reveal">
        <Link href="/blog/cheapest-leads-most-expensive-clients" className="blog-featured-card">
          <div className="blog-featured-visual" style={{ position: 'relative', overflow: 'hidden' }}>
            <Image src="/blog-cheapest-leads.webp" alt="Rows of identical stored goods receding into darkness" fill style={{ objectFit: 'cover' }} />
          </div>
          <div className="blog-featured-content">
            <div className="blog-featured-tag">Paid Media</div>
            <div className="blog-featured-meta">
              <span className="blog-featured-date">September 14, 2026</span>
              <span className="blog-featured-dot" />
              <span className="blog-featured-readtime">7 min read</span>
            </div>
            <div className="blog-featured-title">Your Cheapest Leads Are Probably Your Most Expensive Clients</div>
            <div className="blog-featured-excerpt">Almost every ad account reports cost per lead. Almost none report cost per client. For a business where one customer is worth thousands, those two numbers routinely point in opposite directions.</div>
      ...
      <div className="blog-more reveal" style={{ maxWidth: '960px', margin: '0 auto', padding: '0 2rem 5rem' }}>
        ...
        <div className="blog-bento">
          <Link href="/blog/your-best-channel-looks-like-your-worst" style={{ background: '#111', border: '1px solid #1e1e1e', borderRadius: '12px', padding: '0', textDecoration: 'none', transition: 'border-color 0.2s', overflow: 'hidden' }}>
            ...
            <div style={{ padding: '1.5rem 2rem 2rem' }}>
              <div style={{ fontSize: '0.7rem', fontWeight: 700, color: '#ff6b35', textTransform: 'uppercase', letterSpacing: '1px', marginBottom: '0.75rem' }}>Attribution</div>
              <div style={{ fontSize: '0.8rem', color: '#666', marginBottom: '0.75rem' }}><span>September 3, 2026</span><span style={{ margin: '0 0.5rem' }}>&middot;</span><span>6 min read</span></div>
              <div style={{ fontSize: '1.15rem', fontWeight: 700, color: '#fff', lineHeight: 1.4, marginBottom: '0.75rem' }}>Your Best Channel Might Look Like Your Worst One</div>
              <div style={{ fontSize: '0.9rem', color: '#888', lineHeight: 1.6, marginBottom: '1rem' }}>Every attribution report counts submissions. That quietly penalises the channels bringing you careful, high-consideration prospects.</div>
