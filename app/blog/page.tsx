  ...
  return (
    <div className="blog-page">
      ...
      <div className="blog-featured reveal">
        <Link href="/blog/why-med-spa-leads-vanish-after-hours" className="blog-featured-card">
          ...
          <div className="blog-featured-content">
            <div className="blog-featured-tag">Med Spa &amp; Aesthetics</div>
            <div className="blog-featured-meta">
              <span className="blog-featured-date">June 11, 2026</span>
              <span className="blog-featured-dot" />
              <span className="blog-featured-readtime">7 min read</span>
            </div>
            <div className="blog-featured-title">Why Med Spa Leads Vanish After Hours — And What It Costs You</div>
            <div className="blog-featured-excerpt">Aesthetic inquiries arrive after 5 PM, on mobile, with zero patience. Here is the form-abandonment math behind why med spas lose their highest-intent leads — and what actually closes the gap.</div>
