  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0a0a0a', fontFamily: "'Inter', -apple-system, sans-serif" }}>
      ...
      <div className="blog-post-body" style={{ maxWidth: '720px', margin: '0 auto', padding: '1rem 2rem 3rem' }}>
        ...
        <h2>The Test Drive That Never Happened</h2>
        ...
        <h2>Why Luxury Auto Has the Highest Abandonment</h2>
        ...
        <h2>How ReCapture Works for Luxury Auto</h2>
        ...
        <h2>See How Much Your Dealership Is Losing</h2>
